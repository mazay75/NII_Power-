...
#include "FB_BLINK_gen.cpp"
#endif


DEFINE_FIRMWARE_FB(FORTE_FB_BLINK, g_nStringIdFB_BLINK)

const CStringDictionary::TStringId FORTE_FB_BLINK::scm_anDataInputNames[] = {g_nStringIdENABLE, g_nStringIdTIMELOW, g_nStringIdTIMEHIGH};

const CStringDictionary::TStringId FORTE_FB_BLINK::scm_anDataInputTypeIds[] = {g_nStringIdBOOL, g_nStringIdUINT, g_nStringIdUINT};

const CStringDictionary::TStringId FORTE_FB_BLINK::scm_anDataOutputNames[] = {g_nStringIdOUT};

const CStringDictionary::TStringId FORTE_FB_BLINK::scm_anDataOutputTypeIds[] = {g_nStringIdBOOL};

const TDataIOID FORTE_FB_BLINK::scm_anEIWith[] = {0, 1, 2, 255};
const TForteInt16 FORTE_FB_BLINK::scm_anEIWithIndexes[] = {0};
const CStringDictionary::TStringId FORTE_FB_BLINK::scm_anEventInputNames[] = {g_nStringIdREQ};

const TDataIOID FORTE_FB_BLINK::scm_anEOWith[] = {0, 255};
const TForteInt16 FORTE_FB_BLINK::scm_anEOWithIndexes[] = {0};
const CStringDictionary::TStringId FORTE_FB_BLINK::scm_anEventOutputNames[] = {g_nStringIdCNF};


const SFBInterfaceSpec FORTE_FB_BLINK::scm_stFBInterfaceSpec = {
...
const SCFB_FBInstanceData FORTE_FB_BLINK::scm_astInternalFBs[] = {
...
const SCFB_FBParameter FORTE_FB_BLINK::scm_astParamters[] = {
  {4, g_nStringIdMultiplier, "1000000000"},
  {5, g_nStringIdMultiplier, "1000000000"},
};

const SCFB_FBConnectionData FORTE_FB_BLINK::scm_astEventConnections[] = {
...
const SCFB_FBConnectionData FORTE_FB_BLINK::scm_astDataConnections[] = {
  ...
  {GENERATE_CONNECTION_PORT_ID_1_ARG(g_nStringIdTIMEHIGH), -1, GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdFB_UINT_TO_TIME_1, g_nStringIdInValue), 5},
  ...
  {GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdFB_UINT_TO_TIME_1, g_nStringIdTime), 5, GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdFB_TOF, g_nStringIdPT), 1},
  {GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdFB_And, g_nStringIdxOut), 3, GENERATE_CONNECTION_PORT_ID_1_ARG(g_nStringIdOUT), -1},
};

const SCFB_FBFannedOutConnectionData FORTE_FB_BLINK::scm_astFannedOutDataConnections[] = {
  {1, GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdFB_And, g_nStringIdxIn2), 3},
};

const SCFB_FBNData FORTE_FB_BLINK::scm_stFBNData = {
