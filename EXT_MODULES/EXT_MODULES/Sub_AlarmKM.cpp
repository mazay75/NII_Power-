...
#include "Sub_AlarmKM.h"
#ifdef FORTE_ENABLE_GENERATED_SOURCE_CPP
#include "Sub_AlarmKM_gen.cpp"
#endif


DEFINE_FIRMWARE_FB(FORTE_Sub_AlarmKM, g_nStringIdSub_AlarmKM)

const CStringDictionary::TStringId FORTE_Sub_AlarmKM::scm_anDataInputNames[] = {g_nStringIdxAuto, g_nStringIdxStart, g_nStringIdxKM, g_nStringIdxReset, g_nStringIdSP_DelAlrmKM_OnFan, g_nStringIdSP_DelAlrmKM_OffFan};

const CStringDictionary::TStringId FORTE_Sub_AlarmKM::scm_anDataInputTypeIds[] = {g_nStringIdBOOL, g_nStringIdBOOL, g_nStringIdBOOL, g_nStringIdBOOL, g_nStringIdUINT, g_nStringIdUINT};

const CStringDictionary::TStringId FORTE_Sub_AlarmKM::scm_anDataOutputNames[] = {g_nStringIdxAlarmKM, g_nStringIdET_On, g_nStringIdET_Off};

const CStringDictionary::TStringId FORTE_Sub_AlarmKM::scm_anDataOutputTypeIds[] = {g_nStringIdBOOL, g_nStringIdTIME, g_nStringIdTIME};

const TForteInt16 FORTE_Sub_AlarmKM::scm_anEIWithIndexes[] = {-1};
const CStringDictionary::TStringId FORTE_Sub_AlarmKM::scm_anEventInputNames[] = {g_nStringIdREQ};

const TForteInt16 FORTE_Sub_AlarmKM::scm_anEOWithIndexes[] = {-1};
const CStringDictionary::TStringId FORTE_Sub_AlarmKM::scm_anEventOutputNames[] = {g_nStringIdCNF};


const SFBInterfaceSpec FORTE_Sub_AlarmKM::scm_stFBInterfaceSpec = {
...
const SCFB_FBInstanceData FORTE_Sub_AlarmKM::scm_astInternalFBs[] = {
...
const SCFB_FBParameter FORTE_Sub_AlarmKM::scm_astParamters[] = {
  {2, g_nStringIdMultiplier, "1000000000"},
  {6, g_nStringIdMultiplier, "1000000000"},
};

const SCFB_FBConnectionData FORTE_Sub_AlarmKM::scm_astEventConnections[] = {
...
const SCFB_FBConnectionData FORTE_Sub_AlarmKM::scm_astDataConnections[] = {
  {GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdFB_TON, g_nStringIdET), 0, GENERATE_CONNECTION_PORT_ID_1_ARG(g_nStringIdET_On), -1},
  {GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdFB_SR, g_nStringIdQ1), 1, GENERATE_CONNECTION_PORT_ID_1_ARG(g_nStringIdxAlarmKM), -1},
  ...
  {GENERATE_CONNECTION_PORT_ID_1_ARG(g_nStringIdSP_DelAlrmKM_OnFan), -1, GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdFB_UINT_TO_TIME, g_nStringIdInValue), 2},
  ...
  {GENERATE_CONNECTION_PORT_ID_1_ARG(g_nStringIdxKM), -1, GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdFB_TOF, g_nStringIdIN), 4},
  {GENERATE_CONNECTION_PORT_ID_1_ARG(g_nStringIdSP_DelAlrmKM_OffFan), -1, GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdFB_UINT_TO_TIME_1, g_nStringIdInValue), 6},
...
const SCFB_FBNData FORTE_Sub_AlarmKM::scm_stFBNData = {
