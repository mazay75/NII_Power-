...
#ifndef _SUB_ALARMKM_H_
#define _SUB_ALARMKM_H_
...
class FORTE_Sub_AlarmKM: public CCompositeFB {
  DECLARE_FIRMWARE_FB(FORTE_Sub_AlarmKM)
...
public:
  FORTE_Sub_AlarmKM(const CStringDictionary::TStringId pa_nInstanceNameId, CResource *pa_poSrcRes) :
      CCompositeFB(pa_poSrcRes, &scm_stFBInterfaceSpec, pa_nInstanceNameId, &scm_stFBNData, m_anFBConnData, m_anFBVarsData) {
  };

  virtual ~FORTE_Sub_AlarmKM() = default;
};

#endif // _SUB_ALARMKM_H_
