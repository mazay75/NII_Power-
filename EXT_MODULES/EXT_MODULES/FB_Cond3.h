...
class FORTE_FB_Cond3: public CSimpleFB {
  DECLARE_FIRMWARE_FB(FORTE_FB_Cond3)
...
virtual void setInitialValues();
  ...
  FORTE_BASIC_FB_DATA_ARRAY(1, 4, 3, 1, 0);

public:
  FORTE_FB_Cond3(CStringDictionary::TStringId pa_nInstanceNameId, CResource *pa_poSrcRes) :
       CSimpleFB(pa_poSrcRes, &scm_stFBInterfaceSpec, pa_nInstanceNameId, &scm_stInternalVars, m_anFBConnData, m_anFBVarsData) {
  };

  virtual ~FORTE_FB_Cond3() = default;
};
