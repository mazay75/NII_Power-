...
class FORTE_FB_AND7: public CSimpleFB {
  DECLARE_FIRMWARE_FB(FORTE_FB_AND7)
...
public:
  FORTE_FB_AND7(CStringDictionary::TStringId pa_nInstanceNameId, CResource *pa_poSrcRes) :
       CSimpleFB(pa_poSrcRes, &scm_stFBInterfaceSpec, pa_nInstanceNameId, nullptr, m_anFBConnData, m_anFBVarsData) {
  };

  virtual ~FORTE_FB_AND7() = default;
};
