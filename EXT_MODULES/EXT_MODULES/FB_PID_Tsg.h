...
#ifndef _FB_PID_TSG_H_
#define _FB_PID_TSG_H_
...
class FORTE_FB_PID_Tsg: public CBasicFB {
  DECLARE_FIRMWARE_FB(FORTE_FB_PID_Tsg)
...
virtual void setInitialValues();
  ...
  FORTE_BASIC_FB_DATA_ARRAY(2, 12, 8, 2, 0);

public:
  FORTE_FB_PID_Tsg(CStringDictionary::TStringId pa_nInstanceNameId, CResource *pa_poSrcRes) :
      CBasicFB(pa_poSrcRes, &scm_stFBInterfaceSpec, pa_nInstanceNameId, &scm_stInternalVars, m_anFBConnData, m_anFBVarsData) {
  };

  virtual ~FORTE_FB_PID_Tsg() = default;
};

#endif // _FB_PID_TSG_H_
