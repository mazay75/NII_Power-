...
class FORTE_FB_OR_6: public CSimpleFB {
  DECLARE_FIRMWARE_FB(FORTE_FB_OR_6)
...
public:
  FORTE_FB_OR_6(CStringDictionary::TStringId pa_nInstanceNameId, CResource *pa_poSrcRes) :
       CSimpleFB(pa_poSrcRes, &scm_stFBInterfaceSpec, pa_nInstanceNameId, nullptr, m_anFBConnData, m_anFBVarsData) {
  };

  virtual ~FORTE_FB_OR_6() = default;
};
