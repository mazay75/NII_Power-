...
#include "Sub_AlarmSens1.h"
#ifdef FORTE_ENABLE_GENERATED_SOURCE_CPP
#include "Sub_AlarmSens1_gen.cpp"
#endif


DEFINE_FIRMWARE_FB(FORTE_Sub_AlarmSens1, g_nStringIdSub_AlarmSens1)

const CStringDictionary::TStringId FORTE_Sub_AlarmSens1::scm_anDataInputNames[] = {g_nStringIdxAuto, g_nStringIdxStart, g_nStringIdxAlrmSnsr, g_nStringIdxReset, g_nStringIdSP_DelAlrmDPD_OnFan, g_nStringIdSP_DelAlrmDPD_OffFan};

const CStringDictionary::TStringId FORTE_Sub_AlarmSens1::scm_anDataInputTypeIds[] = {g_nStringIdBOOL, g_nStringIdBOOL, g_nStringIdBOOL, g_nStringIdBOOL, g_nStringIdUINT, g_nStringIdUINT};

const CStringDictionary::TStringId FORTE_Sub_AlarmSens1::scm_anDataOutputNames[] = {g_nStringIdxAlarmDPD, g_nStringIdET_On, g_nStringIdET_Off};

const CStringDictionary::TStringId FORTE_Sub_AlarmSens1::scm_anDataOutputTypeIds[] = {g_nStringIdBOOL, g_nStringIdTIME, g_nStringIdTIME};

const TForteInt16 FORTE_Sub_AlarmSens1::scm_anEIWithIndexes[] = {-1};
const CStringDictionary::TStringId FORTE_Sub_AlarmSens1::scm_anEventInputNames[] = {g_nStringIdREQ};

const TForteInt16 FORTE_Sub_AlarmSens1::scm_anEOWithIndexes[] = {-1};
const CStringDictionary::TStringId FORTE_Sub_AlarmSens1::scm_anEventOutputNames[] = {g_nStringIdCNF};


const SFBInterfaceSpec FORTE_Sub_AlarmSens1::scm_stFBInterfaceSpec = {
...
const SCFB_FBInstanceData FORTE_Sub_AlarmSens1::scm_astInternalFBs[] = {
...
const SCFB_FBParameter FORTE_Sub_AlarmSens1::scm_astParamters[] = {
  {2, g_nStringIdMultiplier, "1000000000"},
  {6, g_nStringIdMultiplier, "1000000000"},
};

const SCFB_FBConnectionData FORTE_Sub_AlarmSens1::scm_astEventConnections[] = {
  ...
  {GENERATE_CONNECTION_PORT_ID_1_ARG(g_nStringIdREQ), -1, GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdFB_NOT, g_nStringIdREQ), 9},
  {GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdFB_NOT, g_nStringIdCNF), 9, GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdFB_And, g_nStringIdREQ), 8},
};

const SCFB_FBConnectionData FORTE_Sub_AlarmSens1::scm_astDataConnections[] = {
  ...
  {GENERATE_CONNECTION_PORT_ID_1_ARG(g_nStringIdxAlrmSnsr), -1, GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdFB_NOT, g_nStringIdxIn1), 9},
  {GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdFB_NOT, g_nStringIdxOut), 9, GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdFB_TOF, g_nStringIdIN), 4},
};

const SCFB_FBFannedOutConnectionData FORTE_Sub_AlarmSens1::scm_astFannedOutDataConnections[] = {
  {13, GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdFB_And, g_nStringIdxIn2), 8},
};

const SCFB_FBNData FORTE_Sub_AlarmSens1::scm_stFBNData = {
