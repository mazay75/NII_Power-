...
#ifndef _SUB_ALARMDPD_H_
#define _SUB_ALARMDPD_H_
...
class FORTE_Sub_AlarmDPD: public CCompositeFB {
  DECLARE_FIRMWARE_FB(FORTE_Sub_AlarmDPD)
...
public:
  FORTE_Sub_AlarmDPD(const CStringDictionary::TStringId pa_nInstanceNameId, CResource *pa_poSrcRes) :
      CCompositeFB(pa_poSrcRes, &scm_stFBInterfaceSpec, pa_nInstanceNameId, &scm_stFBNData, m_anFBConnData, m_anFBVarsData) {
  };

  virtual ~FORTE_Sub_AlarmDPD() = default;
};

#endif // _SUB_ALARMDPD_H_
