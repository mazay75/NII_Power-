...
#ifndef _SUB_2FANSEX_H_
#define _SUB_2FANSEX_H_
...
class FORTE_Sub_2FansEx: public CCompositeFB {
  DECLARE_FIRMWARE_FB(FORTE_Sub_2FansEx)
...
private:
  ...
  CIEC_UINT &st_SP_DelAlrmDPD_OnFan1() {
    return *static_cast<CIEC_UINT*>(getDI(11));
  }
  
  CIEC_UINT &st_SP_DelAlrmDPD_OnFan2() {
    return *static_cast<CIEC_UINT*>(getDI(12));
  }
  
  CIEC_UINT &st_SP_DelAlrmDPD_OffFan1() {
    return *static_cast<CIEC_UINT*>(getDI(13));
  }
  
  CIEC_UINT &st_SP_DelAlrmDPD_OffFan2() {
    return *static_cast<CIEC_UINT*>(getDI(14));
  }
  
  CIEC_UINT &st_SP_DelAlrmKM_OnFan1() {
    return *static_cast<CIEC_UINT*>(getDI(15));
  }
  
  CIEC_UINT &st_SP_DelAlrmKM_OnFan2() {
    return *static_cast<CIEC_UINT*>(getDI(16));
  }
  
  CIEC_UINT &st_SP_DelAlrmKM_OffFan1() {
    return *static_cast<CIEC_UINT*>(getDI(17));
  }
  
  CIEC_UINT &st_SP_DelAlrmKM_OffFan2() {
  ...
  CIEC_BOOL &st_xAlarmReset() {
    return *static_cast<CIEC_BOOL*>(getDI(23));
  }
  ...
  CIEC_UDINT &st_EngineMinutes1() {
    return *static_cast<CIEC_UDINT*>(getDO(12));
  }
  
  CIEC_UDINT &st_EngineMinutes2() {
    return *static_cast<CIEC_UDINT*>(getDO(13));
  }
  ...
  CIEC_WORD &st_wEngineMinutes_0_1() {
    return *static_cast<CIEC_WORD*>(getDO(16));
  }
  
  CIEC_WORD &st_wEngineMinutes_0_2() {
    return *static_cast<CIEC_WORD*>(getDO(17));
  }
  ...
  FORTE_FB_DATA_ARRAY(2, 24, 24, 0);

public:
  FORTE_Sub_2FansEx(const CStringDictionary::TStringId pa_nInstanceNameId, CResource *pa_poSrcRes) :
      CCompositeFB(pa_poSrcRes, &scm_stFBInterfaceSpec, pa_nInstanceNameId, &scm_stFBNData, m_anFBConnData, m_anFBVarsData) {
  };

  virtual ~FORTE_Sub_2FansEx() = default;
};

#endif // _SUB_2FANSEX_H_
