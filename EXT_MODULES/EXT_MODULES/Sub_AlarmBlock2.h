...
#ifndef _SUB_ALARMBLOCK2_H_
#define _SUB_ALARMBLOCK2_H_
...
class FORTE_Sub_AlarmBlock2: public CCompositeFB {
  DECLARE_FIRMWARE_FB(FORTE_Sub_AlarmBlock2)
...
public:
  FORTE_Sub_AlarmBlock2(const CStringDictionary::TStringId pa_nInstanceNameId, CResource *pa_poSrcRes) :
      CCompositeFB(pa_poSrcRes, &scm_stFBInterfaceSpec, pa_nInstanceNameId, &scm_stFBNData, m_anFBConnData, m_anFBVarsData) {
  };

  virtual ~FORTE_Sub_AlarmBlock2() = default;
};

#endif // _SUB_ALARMBLOCK2_H_
