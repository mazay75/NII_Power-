...
#include "Sub_2FansEx.h"
#ifdef FORTE_ENABLE_GENERATED_SOURCE_CPP
#include "Sub_2FansEx_gen.cpp"
#endif


DEFINE_FIRMWARE_FB(FORTE_Sub_2FansEx, g_nStringIdSub_2FansEx)

const CStringDictionary::TStringId FORTE_Sub_2FansEx::scm_anDataInputNames[] = {g_nStringIdxAuto, g_nStringIdxStart1, g_nStringIdxStart2, g_nStringIdxDPD1, g_nStringIdxDPD2, g_nStringIdxKM1, g_nStringIdxKM2, g_nStringIdxStatusQF1, g_nStringIdxStatusQF2, g_nStringIdxTK1, g_nStringIdxTK2, g_nStringIdSP_DelAlrmDPD_OnFan1, g_nStringIdSP_DelAlrmDPD_OnFan2, g_nStringIdSP_DelAlrmDPD_OffFan1, g_nStringIdSP_DelAlrmDPD_OffFan2, g_nStringIdSP_DelAlrmKM_OnFan1, g_nStringIdSP_DelAlrmKM_OnFan2, g_nStringIdSP_DelAlrmKM_OffFan1, g_nStringIdSP_DelAlrmKM_OffFan2, g_nStringIdvar_EngineMinutes1, g_nStringIdvar_EngineMinutes2, g_nStringIdvar_EngineHours1, g_nStringIdvar_EngineHours2, g_nStringIdxAlarmReset};

const CStringDictionary::TStringId FORTE_Sub_2FansEx::scm_anDataInputTypeIds[] = {g_nStringIdBOOL, g_nStringIdBOOL, g_nStringIdBOOL, g_nStringIdBOOL, g_nStringIdBOOL, g_nStringIdBOOL, g_nStringIdBOOL, g_nStringIdBOOL, g_nStringIdBOOL, g_nStringIdBOOL, g_nStringIdBOOL, g_nStringIdUINT, g_nStringIdUINT, g_nStringIdUINT, g_nStringIdUINT, g_nStringIdUINT, g_nStringIdUINT, g_nStringIdUINT, g_nStringIdUINT, g_nStringIdWSTRING, g_nStringIdWSTRING, g_nStringIdWSTRING, g_nStringIdWSTRING, g_nStringIdBOOL};

const CStringDictionary::TStringId FORTE_Sub_2FansEx::scm_anDataOutputNames[] = {g_nStringIdxFan1, g_nStringIdxFan2, g_nStringIdxAlarmFan1, g_nStringIdxAlarmFan2, g_nStringIdxAlarmDPD1, g_nStringIdxAlarmDPD2, g_nStringIdxAlarmKM1, g_nStringIdxAlarmKM2, g_nStringIdxAlarmQF1, g_nStringIdxAlarmQF2, g_nStringIdxAlarmTK1, g_nStringIdxAlarmTK2, g_nStringIdEngineMinutes1, g_nStringIdEngineMinutes2, g_nStringIdEngineHours1, g_nStringIdEngineHours2, g_nStringIdwEngineMinutes_0_1, g_nStringIdwEngineMinutes_0_2, g_nStringIdwEngineMinutes_1_1, g_nStringIdwEngineMinutes_1_2, g_nStringIdwEngineHours_0_1, g_nStringIdwEngineHours_0_2, g_nStringIdwEngineHours_1_1, g_nStringIdwEngineHours_1_2};

const CStringDictionary::TStringId FORTE_Sub_2FansEx::scm_anDataOutputTypeIds[] = {g_nStringIdBOOL, g_nStringIdBOOL, g_nStringIdBOOL, g_nStringIdBOOL, g_nStringIdBOOL, g_nStringIdBOOL, g_nStringIdBOOL, g_nStringIdBOOL, g_nStringIdBOOL, g_nStringIdBOOL, g_nStringIdBOOL, g_nStringIdBOOL, g_nStringIdUDINT, g_nStringIdUDINT, g_nStringIdUDINT, g_nStringIdUDINT, g_nStringIdWORD, g_nStringIdWORD, g_nStringIdWORD, g_nStringIdWORD, g_nStringIdWORD, g_nStringIdWORD, g_nStringIdWORD, g_nStringIdWORD};

const TForteInt16 FORTE_Sub_2FansEx::scm_anEIWithIndexes[] = {-1, -1};
const CStringDictionary::TStringId FORTE_Sub_2FansEx::scm_anEventInputNames[] = {g_nStringIdINIT, g_nStringIdREQ};

const TForteInt16 FORTE_Sub_2FansEx::scm_anEOWithIndexes[] = {-1, -1};
const CStringDictionary::TStringId FORTE_Sub_2FansEx::scm_anEventOutputNames[] = {g_nStringIdINITO, g_nStringIdCNF};


const SFBInterfaceSpec FORTE_Sub_2FansEx::scm_stFBInterfaceSpec = {
  2, scm_anEventInputNames, nullptr, scm_anEIWithIndexes,
  2, scm_anEventOutputNames, nullptr, scm_anEOWithIndexes,
  24, scm_anDataInputNames, scm_anDataInputTypeIds,
  24, scm_anDataOutputNames, scm_anDataOutputTypeIds,
  0, nullptr
};

const SCFB_FBInstanceData FORTE_Sub_2FansEx::scm_astInternalFBs[] = {
  {g_nStringIdSub_Fan_0, g_nStringIdSub_Fan},
  {g_nStringIdSub_Fan_1, g_nStringIdSub_Fan}
};


const SCFB_FBConnectionData FORTE_Sub_2FansEx::scm_astEventConnections[] = {
...
const SCFB_FBConnectionData FORTE_Sub_2FansEx::scm_astDataConnections[] = {
  ...
  {GENERATE_CONNECTION_PORT_ID_1_ARG(g_nStringIdSP_DelAlrmDPD_OnFan1), -1, GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdSub_Fan_0, g_nStringIdSP_DelAlrmDPD_OnFan), 0},
  ...
  {GENERATE_CONNECTION_PORT_ID_1_ARG(g_nStringIdSP_DelAlrmDPD_OffFan1), -1, GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdSub_Fan_0, g_nStringIdSP_DelAlrmDPD_OffFan), 0},
  {GENERATE_CONNECTION_PORT_ID_1_ARG(g_nStringIdSP_DelAlrmKM_OnFan1), -1, GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdSub_Fan_0, g_nStringIdSP_DelAlrmKM_OnFan), 0},
  {GENERATE_CONNECTION_PORT_ID_1_ARG(g_nStringIdSP_DelAlrmKM_OffFan1), -1, GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdSub_Fan_0, g_nStringIdSP_DelAlrmKM_OffFan), 0},
  ...
  {GENERATE_CONNECTION_PORT_ID_1_ARG(g_nStringIdSP_DelAlrmDPD_OnFan2), -1, GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdSub_Fan_1, g_nStringIdSP_DelAlrmDPD_OnFan), 1},
  {GENERATE_CONNECTION_PORT_ID_1_ARG(g_nStringIdSP_DelAlrmDPD_OffFan2), -1, GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdSub_Fan_1, g_nStringIdSP_DelAlrmDPD_OffFan), 1},
  {GENERATE_CONNECTION_PORT_ID_1_ARG(g_nStringIdSP_DelAlrmKM_OnFan2), -1, GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdSub_Fan_1, g_nStringIdSP_DelAlrmKM_OnFan), 1},
  {GENERATE_CONNECTION_PORT_ID_1_ARG(g_nStringIdSP_DelAlrmKM_OffFan2), -1, GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdSub_Fan_1, g_nStringIdSP_DelAlrmKM_OffFan), 1},
...
const SCFB_FBFannedOutConnectionData FORTE_Sub_2FansEx::scm_astFannedOutDataConnections[] = {
  {0, GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdSub_Fan_1, g_nStringIdxAuto), 1},
  {7, GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdSub_Fan_1, g_nStringIdxReset), 1},
};

const SCFB_FBNData FORTE_Sub_2FansEx::scm_stFBNData = {
